export default function Summary(props) {
  ...
  return (
    <div className="w-3/4  p-1 mt-1 sm:order-4 lg:order-5 sm:w-2/3 sm:px-4 lg:w-2/4">
      ...
      <p className="  text-xs lg:text-sm text-white mb-4 mt-1 sm:mt-5 md:mt-0">{truncateSummary(game.summary, 500)}</p>
    </div>)
}